...
//THUMBNAILS
// const thumbNail = document.querySelector(".card")
// const thumbsDivs = `<div class="thumb" style="height: calc(300px / ${imgsArray.lenght})"> <img src="${currentImg}" alt=""/> </div>`;
      
//    thumbNail.innerHTML += thumbsDivs 
